...
As a performance engineering lead for a large French public infrastructure operator, I design load testing strategies, build observability platforms, and help teams shift performance left — treating it as a continuous engineering practice rather than a late-stage gate.
...
The [curated tools list](/awesome-performance-engineering/) and the [reading library](/library/) I maintain reflect the same practice in public form. The [Bloom Perf project](/projects/bloom-perf/) is where I tinker with performance-testing methodology.

## My journey into tech

I have been around computing for as long as I can remember — software development, open-source involvement, and a long-running interest in artificial intelligence.
...
The first computer I had access to was the famous [Sinclair ZX81](https://en.wikipedia.org/wiki/ZX81). We were in early 1980's (for the younger of us: imagine living in [Stranger Things](https://www.youtube.com/watch?v=b9EkMc79ZSU)), the Cold War was in full swing and we were fascinated by the [Wargames](https://www.youtube.com/watch?v=TQUsLAAZuhU) film, it seemed like pure fantasy – as distant as flying cars or teleportation. Fast forward to today, and I find myself having actual conversations with AI systems that would make WOPR (the AI computer in Wargames) look like a pocket calculator. The line between yesterday's science fiction and today's reality has not just blurred – it's been completely redrawn.

### The first Linux distribution

The first linux distribution I have installed is **Yggdrassil Plug And Play Linux Fall 1994**. This distribution was one of the first on CD ROM. Previously, Linux distributions were supplied on about fifteen 3 1/2 floppy disks!
